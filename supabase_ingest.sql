...
-- Nota: SQL dinâmico para escolher a tabela
if v_table = 'pageviews' then
...
$$;
-- Habilitar Realtime para as tabelas (Essencial para o Log funcionar)
begin;
-- Verifica se a publicação existe, se não cria (padrão do Supabase é existir)
